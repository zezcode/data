...
if (process.argv.length < 6) {
  ...
  console.log(`\x1b[36m USAGE\x1b[37m: node ${fileName} <target> <time> <thread> <proxies>`);
  console.log(`\x1b[32m EXAMPLE\x1b[37m: node ${fileName} https://example.com 60 100 proxy.txt`);
...
ATTACK: ${target}     TIME: ${time}     THREAD: ${thread}     PROXIES: ${count}
